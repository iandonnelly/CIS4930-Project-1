...
public class ClientTabsFragment extends BaseTabFragment {
    public static ClientTabsFragment newInstance(String serverName) {
        ClientTabsFragment fragment = new ClientTabsFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Add the primary client tab
        mTabs.add(new Tab(
                ClientFragment.TAB_FACTORY,
                null,
    ...
    public void addTab(String channel) {
        mTabs.add(new Tab(
                ClientChannelFragment.TAB_FACTORY,
                null,
                channel,
                getResources().getColor(R.color.primary),
                Color.GRAY
